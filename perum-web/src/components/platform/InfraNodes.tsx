...
export function NodeRow({ node, util, onInstall, onDrain, onDelete }: {
    node: any;
    util?: NodeUtil;
    onInstall: () => void;
    onDrain: () => void;
...
export function CreateNodeWizard({ orgs, onClose, onCreated }: {
    ...
    const secretKey = useMemo(() => genSecret(), []);
                ...
                {step === 1 ? (
                    <>
                        ...
                        <div className={s.field}>
                            <label className={s.label}>Secret Key (SECRET_KEY)</label>
                            <div className={s.secretRow}>
                                <input className={s.secretInput} value={secretKey} readOnly />
                                <CopyBtn text={secretKey} className={s.copyIcon} okClassName={s.copyIconOk}>
