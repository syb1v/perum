...
const capabilities = {
  ...
  support_requester: true, support_admin: true, support_attachments: false, offline_preferences: true, student_academics: true, parent_academics: true, parent_analytics: true, teacher_diary: true, teacher_homeroom: true, teacher_works: true, teacher_analytics: true, offline_homework_state: true,
