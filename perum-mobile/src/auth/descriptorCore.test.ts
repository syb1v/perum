...
function discovery(overrides: Partial<Discovery> = {}): Discovery {
  return {
    ...
    capabilities: {
      ...
      support_requester: true, support_admin: true, support_attachments: false, offline_preferences: true, student_academics: true, student_analytics: true, parent_academics: true, parent_analytics: true, teacher_diary: true, teacher_homeroom: true, teacher_works: true, teacher_analytics: true, school_admin_overview: true, school_admin_social_moderation: true, school_admin_academic_calendar: true, school_admin_class_directory: true, school_admin_teacher_directory: true, school_admin_bell_schedules: true, school_admin_work_types: true, offline_homework_state: true,
