...
function discovery(overrides: Partial<Discovery> = {}): Discovery {
  return {
    ...
    capabilities: {
      ...
      support_requester: true, support_admin: true, support_attachments: false, offline_preferences: true, student_academics: true, parent_academics: true, offline_homework_state: true,
