...
const base = { descriptorCapabilities: { social_messages: true, social_realtime: false, student_academics: true, parent_academics: true, teacher_diary: true, teacher_homeroom: true } } as TenantAccount;
