...
export const capabilityNames = [
  ...
  'student_academics', 'student_analytics', 'parent_academics', 'parent_analytics', 'teacher_diary', 'teacher_homeroom', 'teacher_works', 'teacher_analytics', 'school_admin_overview', 'school_admin_social_moderation', 'school_admin_academic_calendar', 'school_admin_class_directory', 'school_admin_teacher_directory', 'offline_homework_state', 'offline_social_messages', 'offline_support_messages',
