...
export const capabilityNames = [
  ...
  'student_academics', 'parent_academics', 'teacher_diary', 'teacher_homeroom', 'teacher_works', 'offline_homework_state', 'offline_social_messages', 'offline_support_messages',
