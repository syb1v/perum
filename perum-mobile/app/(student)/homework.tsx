...
const styles = StyleSheet.create({ title: { fontSize: 30, fontWeight: '800', color: colors.ink, marginBottom: 20 }, card: { padding: 18, borderWidth: 1, borderColor: colors.border, borderRadius: 14, marginBottom: 12, backgroundColor: colors.surface }, subject: { color: colors.primary, fontWeight: '700' }, name: { color: colors.ink, fontSize: 19, fontWeight: '700', marginTop: 6 }, body: { color: colors.muted, marginTop: 6 }, meta: { color: colors.muted, marginTop: 10, fontSize: 12 }, actions: { flexDirection: 'row', gap: 10, marginTop: 14, flexWrap: 'wrap' }, action: { color: colors.primary, fontWeight: '700', padding: 6 }, active: { color: colors.ink }, conflict: { marginTop: 12, padding: 12, borderRadius: 10, backgroundColor: '#351F08' } });
