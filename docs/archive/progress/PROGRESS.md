...
**Текущий продуктовый шаг:** optimistic locking обновления и удаления Grade
реализован сквозным контрактом tenant API и web. Следующий шаг
[PRODUCT_MASTER_PLAN.md](PRODUCT_MASTER_PLAN.md) WS1 — version-safe перенос
`LessonOccurrence`, затем offline mutation contracts и conflict QA.
