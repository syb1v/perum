...
**Текущий этап:** Stage F, one-school pilot dynamic mobile descriptor; automated
matrix, CI и безопасный operator checklist закрыты, ожидается pilot evidence.

**Следующий roadmap:** выполнить one-school pilot по подготовленному checklist и
закрыть lifecycle matrix operator evidence; затем перейти к durable read cursors,
offline support ticket creation и multi-device conflict QA.
