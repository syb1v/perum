...
| P1 | Учебный hardening | Частично | optimistic locking Grade и version-safe LessonOccurrence/safe transfer готовы; Homework разделён на assigned/target occurrence, publication/deadline и versioned student state с web/mobile UI, durable idempotency и SQLite outbox, остаются occurrence backfill, архивирование и расширенный conflict QA |
