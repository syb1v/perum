...
**Готовность ≈ 86 %** (по работающим фичам; фронт ~100% присутствует — скопирован из легаси). **Фазы 5–9 закрыты + переархитектура v2 «узел организации» (silo=школа, OTA по кнопке).** Оценка, темп и прогноз сроков — в [VERSIONS.md](VERSIONS.md).
