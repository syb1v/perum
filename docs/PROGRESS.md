...
**Осталось:**
1. **Фаза 6 — закрыта.** Дальше — **Фаза 7 (геймификация): маркет, биржа ливок, квесты, рейтинги.** Контракты — в легаси (`R1dnis/PERUM`), фронт-экраны уже скопированы (`/student/market`, `/student/exchange`, квесты на дашборде, лидерборды).
