...
## Готовность продукта (оценка на №39)

**≈ 76 %** по работающим фичам (взвешенно по фазам). **Фазы 6 и 7 закрыты
полностью.** **Фаза 8 почти закрыта** — готовы новости (лента/лайки/прочтение +
админ-CRUD) и **аналитика** (дашборды учителя: KPI/динамика/проблемные
темы/ученики/работы; админ: обзор школы, успеваемость, экономика; трекинг
переходов); осталась только апелляции на оценки. Дальше — Фаза 4 (домены/TLS) и
...
| 8 Аналитика/новости/родители | 9 | 🔶 ~90% | 8 |
