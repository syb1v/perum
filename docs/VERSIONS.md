...
## Готовность продукта (оценка на №67)

**≈ 89 %** по работающим фичам (взвешенно). **Фазы 4–9 закрыты.** Фаза 4: кастомные
...
требование «обновление по воздуху по кнопке». Дальше — Фаза 10 (hardening/RBAC-
