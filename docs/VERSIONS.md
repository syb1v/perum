...
## Готовность продукта (оценка на №25)

**≈ 51 %** по работающим фичам (взвешенно по фазам). Фаза 6 закрыта почти
полностью (журнал, кабинеты ученика и родителя, ДЗ/контрольные) — остался лишь
импорт оценок из PDF. Нюанс: фронтенд (легаси,
