...
| 104 | 2026-06-20 | _______ | docs(web): актуализирован FAQ управления нодами (скрипт установки, авто-железо/статусы, питание/перезагрузка/массовые действия) + VERSION=1.1.0 + не залипающее предупреждение об откате апдейта (прод-конфиг OTA исправлен вручную)
