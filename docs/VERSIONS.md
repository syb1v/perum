...
## Готовность продукта (оценка на №37)

**≈ 71 %** по работающим фичам (взвешенно по фазам). **Фазы 6 и 7 закрыты
полностью.** **Фаза 8 начата** — готовы новости (лента/лайки/прочтение + админ-
CRUD); осталось аналитика и апелляции. Дальше — Фаза 4 (домены/TLS) и
...
| 8 Аналитика/новости/родители | 9 | 🔶 ~35% | 3 |
