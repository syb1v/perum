...
## Готовность продукта (оценка на №31)

**≈ 58 %** по работающим фичам (взвешенно по фазам). **Фаза 6 закрыта полностью.**
**Фаза 7 (~45%)** — готовы рейтинги и маркет; осталось квесты и биржа ливок
(самая сложная часть). Нюанс: фронтенд (легаси,
...
| 7 Геймификация (маркет/биржа/квесты/рейтинги) | 16 | 🔶 ~45% | 7 |
