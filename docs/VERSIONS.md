...
| 110 | 2026-06-20 | _______ | feat(nodes): реальные метрики нод (CPU/ОЗУ/ПЗУ/пинг), реал-тайм 2с, авто-обновление воркора (Watchtower), полный рестарт стека, ёмкость по лимиту оператора, docs/WORKER.md
