...
## Готовность продукта (оценка на №33)

**≈ 62 %** по работающим фичам (взвешенно по фазам). **Фаза 6 закрыта полностью.**
**Фаза 7 (~65%)** — готовы рейтинги, маркет и квесты; осталась биржа ливок
(самая сложная часть фазы). Нюанс: фронтенд (легаси,
...
| 7 Геймификация (маркет/биржа/квесты/рейтинги) | 16 | 🔶 ~65% | 10 |
