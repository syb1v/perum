...
| 107 | 2026-06-20 | _______ | feat(nodes): провижининг и обновление школ на удалённых нодах (ядро→воркер) + маршрут платформа→нода + переписан bootstrap ноды; проверено вживую на 2-й ноде (nodeschool.avari-land.ru)
