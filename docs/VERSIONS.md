...
## Готовность продукта (оценка на №41)

**≈ 77 %** по работающим фичам (взвешенно по фазам). **Фазы 5, 6, 7 и 8 закрыты
полностью.** Фаза 8 завершена апелляциями на оценки (после новостей и аналитики);
Фаза 5 — хвостами (управление пользователями, редактор расписания с подгруппами,
массовая синхронизация назначений учителей). Дальше — Фаза 4 (домены/TLS) и
