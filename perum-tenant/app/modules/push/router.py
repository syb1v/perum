...
from app.modules.push.schemas import PushRegistrationOut, PushRegistrationRevokeOut, PushRegistrationStatusOut, RegistrationPut

router = APIRouter()


@router.get("/push/registration", response_model=PushRegistrationStatusOut)
...
@router.put("/push/installations/{installation_id}/registration", response_model=PushRegistrationOut)
...
@router.delete("/push/installations/{installation_id}/registration", response_model=PushRegistrationRevokeOut)
