    ...
    assert response.json() == {
        ...
        "capabilities": dict.fromkeys(
            [
                ...
                "support_requester", "support_admin", "support_attachments", "offline_preferences", "student_academics", "student_analytics", "parent_academics", "parent_analytics", "teacher_diary", "teacher_homeroom", "teacher_works", "teacher_analytics", "school_admin_overview", "school_admin_social_moderation", "school_admin_academic_calendar", "school_admin_class_directory", "school_admin_teacher_directory", "school_admin_bell_schedules", "school_admin_work_types", "offline_homework_state",
