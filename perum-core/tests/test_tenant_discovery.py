    ...
    assert response.json() == {
        ...
        "capabilities": dict.fromkeys(
            [
                ...
                "support_requester", "support_admin", "support_attachments", "offline_preferences", "student_academics", "parent_academics", "teacher_diary", "teacher_homeroom", "offline_homework_state",
