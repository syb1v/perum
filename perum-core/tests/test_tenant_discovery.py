    ...
    assert response.json() == {
        ...
        "capabilities": dict.fromkeys(
            [
                ...
                "support_requester", "support_admin", "support_attachments", "offline_preferences", "student_academics", "parent_academics", "parent_analytics", "teacher_diary", "teacher_homeroom", "teacher_works", "teacher_analytics", "offline_homework_state",
